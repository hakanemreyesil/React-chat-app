...
/** 
    *!  Kullanıcının bulunduğu kanalları göstermek.
    */
...
const ResultsDropdown = ({ teamChannels, directChannels, focusedId, loading, setChannel, setToggleContainer }) => {
  ...
  return (
    <div className='channel-search__results'>
      <p className='channel-search__results-header'>Kanallar</p>
      ...
      <p className='channel-search__results-header'>Kullanıcılar</p>
